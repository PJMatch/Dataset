...
class SSHFileApp:
    """
    Application to count how many sentences were recorded by volunteers.

    The application also shows which sentences were recorded from the dataset by id sentence
    """
